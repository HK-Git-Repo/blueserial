...
public class MainActivity extends Activity {
	...
	private class ConnectBT extends AsyncTask<Void, Void, Void> {
		...
		@Override
		protected void onPreExecute() {
			progressDialog = new ProgressDialog(new MyApplication());
			progressDialog.setTitle("Hold on");
			progressDialog.setMessage("Connection");
			//progressDialog = ProgressDialog.show(MyApplication(), "Hold on", "Connecting");// http://stackoverflow.com/a/11130220/1287554
		}
